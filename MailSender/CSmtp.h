...
// Proxy
public:
	void setProxy(const char* proxyHost, unsigned short proxPort, const char* proxyUsername, const char* proxyPasswrod);

private:
	CProxy m_proxy;
	std::string m_sProxyHost;
	unsigned short m_iProxyPort;
	std::string m_sProxyUsername;
